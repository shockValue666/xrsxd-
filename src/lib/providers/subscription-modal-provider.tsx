...
const SubscriptionModalContext = createContext<SubscriptionModalContextType>({open:false,setOpen:()=>{}});
...
export const SubscriptionModalProvider = ({children,products}:{children:React.ReactNode,products:ProductWithPrice[]}) => {
    ...
    return (<SubscriptionModalContext.Provider value={{open,setOpen}}>
        {children}
