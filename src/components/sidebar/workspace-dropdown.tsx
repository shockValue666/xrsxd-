...
import WorkspaceCreator from '../global/workspace-createor';
                    ...
                    <div className='rounded-md flex flex-col'>
                        <div className='!p-2'>
                            {!!privateWorkspaces.length && <>
                                ...
                                <hr />
                                {privateWorkspaces.map((option)=><SelectedWorkspace key={option.id} workspace={option} onClick={handleSelect} />)}
                            </>}

                            {!!collaboratingWorkspaces.length && <>
                                <p className='text-muted-foreground'>Collaborating</p>
                                <hr />
                                {collaboratingWorkspaces.map((option)=><SelectedWorkspace key={option.id} workspace={option} onClick={handleSelect} />)}
                            </>}
